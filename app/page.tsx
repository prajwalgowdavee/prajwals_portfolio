  ...
  return (
    <main>
      ...
      <section className="hero section-shell" id="hero">
        ...
        <div className="hero-visual visual-orbit" aria-hidden="true">
          <div className="orb orb-one" />
          <div className="orb orb-two" />
          <div className="glass-card">
            <span>AI</span>
            <strong>Signal over noise</strong>
            <small>ML / LLMs / Automation</small>
          </div>
        </div>
      </section>
      ...
      <section className="section-shell contact" id="contact">
        ...
        <div className="contact-panel">
          <form action="mailto:prajwal@example.com" method="post" encType="text/plain">
            ...
            <label>
              Message
              <textarea name="message" placeholder="Tell me what you want to build" />
            </label>
